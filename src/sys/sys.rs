...
pub const IORING_OP_GETDENTS: io_uring_op = 49;
...
fn bindgen_test_layout_io_uring_notification_slot() {
    const UNINIT: ::core::mem::MaybeUninit<io_uring_notification_slot> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_io_uring_notification_register() {
    const UNINIT: ::core::mem::MaybeUninit<io_uring_notification_register> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).nr_slots) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_io_uring_buf_ring__bindgen_ty_1() {
    const UNINIT: ::core::mem::MaybeUninit<io_uring_buf_ring__bindgen_ty_1> =
        ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
